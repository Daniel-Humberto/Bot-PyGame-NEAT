...
# Definición clara de áreas y secciones - LAYOUT MEJORADO
MAIN_GAME_WIDTH = 960  # 50% del ancho total para juego principal
MAIN_GAME_HEIGHT = 700  # Altura para juego principal
SIDEBAR_WIDTH = SCREEN_WIDTH - MAIN_GAME_WIDTH  # Ancho para barra lateral
...
# ============================================================================
# FUNCIONES DE UI - COMPONENTEzS REUTILIZABLES
# ============================================================================
...
def draw_main_game(surface, game):
    ...
    main_game_rect = pygame.Rect(
        MARGIN,
        MARGIN,
        MAIN_GAME_WIDTH - 2*MARGIN,  # Ajuste para mantener margen consistente
        MAIN_GAME_HEIGHT
    )
...
def draw_mini_games(surface, games):
    ...
    grid_panel = pygame.Rect(
        ...
        MARGIN,
        SIDEBAR_WIDTH - 2*MARGIN,  # Ajuste para mantener margen consistente
...
def draw_network_info(surface):
    ...
    # Panel para información NEAT - POSICIÓN CORREGIDA
    info_panel = pygame.Rect(
        MAIN_GAME_WIDTH + MARGIN,
        MINI_GAME_SIZE * 3 + MARGIN * 2 + 50 + PADDING * 3,  # Debajo de mini-juegos
        SIDEBAR_WIDTH - 2*MARGIN,  # Ajuste para mantener margen consistente
        280  # Altura reducida para evitar solapamiento
    )
...
def draw_fitness_graph(surface):
    ...
    # Panel para el gráfico - POSICIÓN CORREGIDA
    graph_panel = pygame.Rect(
        MAIN_GAME_WIDTH + MARGIN,
        MINI_GAME_SIZE * 3 + MARGIN * 2 + 50 + PADDING * 3 + 280 + PADDING,  # Debajo del panel info NEAT
        SIDEBAR_WIDTH - 2*MARGIN,  # Ajuste para mantener margen consistente
        265  # Altura ajustada para evitar solapamiento con el panel de estadísticas
    )
...
def draw_stats_panel(surface):
    ...
    # Panel principal de estadísticas - POSICIÓN CORREGIDA
...
def draw_interface(surface, games):
    ...
    # Dibujar panel de información NEAT
    draw_network_info(surface)

    # Dibujar gráfico de fitness histórico
    draw_fitness_graph(surface)

    # Dibujar panel de estadísticas globales
