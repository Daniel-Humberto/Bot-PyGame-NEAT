...
WHITE = (255, 255, 255)
BLACK = (0, 0, 0)
LIGHT_GRAY = (200, 200, 200)  # Gris claro para nubes en modo día
DARK_GRAY = (100, 100, 100)   # Gris oscuro para nubes en modo noche
...
class Game:
    ...
    def show_start_screen(self):
        ...
        SCREEN.blit(title_text, (display_width // 2 - 40, display_height // 2 - 50))
        SCREEN.blit(start_text, (display_width // 2 - 110, display_height // 2))
        SCREEN.blit(instructions_text, (display_width // 2 - 140, display_height // 2 + 50))

        # Mostrar récord actual en la pantalla de inicio
        if self.highscore > 0:
            highscore_text = font.render(f"Highscore: {self.highscore}", True, current_colors['foreground'])
            SCREEN.blit(highscore_text, (display_width // 2 - 60, display_height // 2 + 80))
